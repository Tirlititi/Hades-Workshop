...
#define HADES_STRING_CSV_STATINIT_HEADER	L"# This file contains base stats of characters.\n"\
											...
											L"# String;Int32;UInt8;UInt8;UInt8;UInt8;UInt8\n"\
											L"# -----------------------------------------------\n"
...
#define HADES_STRING_CSV_STATCMD_HEADER	L"#! IncludeId\n"\
										...
										L"# -----------------------------------------------\n"\
										L"# Id;Regular 1;Regular 2;Trance 1;Trance 2\n"\
										L"# Int32;Int32;Int32;Int32;Int32\n"\
										L"# -----------------------------------------------\n"
...
#define HADES_STRING_CSV_SUPPORT_HEADER	L"#! IncludeBoosted\n"\
										...
										L"# String;Int32;UInt8;Int32[]\n"\
										L"# -----------------------------------------------\n"

#define HADES_STRING_CSV_MGCSWORD_FILE		"Data\\Battle\\MagicSwordSets.csv"
#define HADES_STRING_CSV_MGCSWORD_HEADER	L"# This file contains sets of ablities that get unlocked by other abilities.\n"\
											L"# -----------------------------------------------\n"\
											L"# Id;Supporter;Beneficiary;BaseAbilities;UnlockedAbilities\n"\
...
#define HADES_STRING_CSV_USABLE_HEADER	L"#! IncludeId\n"\
										...
										L"# Int32;UInt8;Bit;UInt8;Int16;Bit;Bit;Int32;Int32;Int32;UInt8;UInt32\n"\
										L"# -----------------------------------------------\n"
...
#define HADES_STRING_CSV_ITEM_HEADER	L"#! IncludeId\n"\
										...
										L"# -----------------------------------------------\n"\
										L"# Id;WeaponId;ArmorId;EffectId;Price;GraphicsId;ColorId;Quality;BonusId;AbilityIds;Weapon;Armlet;Helmet;Armor;Accessory;Item;Gem;Usable;Order;Zidane;Vivi;Garnet;Steiner;Freya;Quina;Eiko;Amarant;Cinna;Marcus;Blank;Beatrix\n"\
										L"# Int32;Int32;Int32;Int32;UInt32;UInt8;UInt8;Single;Int32;Ability[];Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Single;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit;Bit\n"\
										L"# -----------------------------------------------\n"
