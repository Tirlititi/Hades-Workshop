...
map<wstring, int> SCRIPT_ARG_TYPE_MAP = {
	{ L"USPIN",				AT_USPIN },
	{ L"BOOL",				AT_BOOL },
	{ L"BOOLLIST",			AT_BOOLLIST },
	{ L"TEXT",				AT_TEXT },
	{ L"BATTLE",			AT_BATTLE },
	{ L"FIELD",				AT_FIELD },
	{ L"DISC_FIELD",		AT_DISC_FIELD },
	{ L"ATTACK",			AT_ATTACK },
	{ L"ITEM",				AT_ITEM },
	{ L"MENUTYPE",			AT_MENUTYPE },
	{ L"MENU",				AT_MENU },
	{ L"CHARACTER",			AT_CHARACTER },
	{ L"LCHARACTER",		AT_LCHARACTER },
	{ L"ABILITYSET",		AT_ABILITYSET },
	{ L"EQUIPSET",			AT_EQUIPSET },
	{ L"FMV",				AT_FMV },
	{ L"ENTRY",				AT_ENTRY },
	...
	{ L"SOUND",				AT_SOUND },
	{ L"AUDIO",				AT_AUDIO },
	{ L"BUBBLESYMBOL",		AT_BUBBLESYMBOL },
	{ L"WORLDMAP",			AT_WORLDMAP },
	{ L"TILE",				AT_TILE },
	{ L"TILEANIM",			AT_TILEANIM },
	{ L"ABILITY",			AT_ABILITY },
	{ L"BATTLECODE",		AT_BATTLECODE },
	{ L"WALKPATH",			AT_WALKPATH },
	{ L"WALKTRIANGLE",		AT_WALKTRIANGLE },
	{ L"POSITION_X",		AT_POSITION_X },
	{ L"POSITION_Y",		AT_POSITION_Y },
	{ L"POSITION_Z",		AT_POSITION_Z },
	{ L"ANGLE",				AT_ANGLE },
	{ L"MODELCODE",			AT_MODELCODE },
	{ L"WORLDCODE",			AT_WORLDCODE },
	{ L"SOUNDCODE",			AT_SOUNDCODE },
	{ L"SPSCODE",			AT_SPSCODE },
	{ L"ANIMATION",			AT_ANIMATION },
	{ L"ANIMFLAG",			AT_ANIMFLAG },
	{ L"DECK",				AT_DECK },
	{ L"SCRIPTLVL",			AT_SCRIPTLVL },
	{ L"BUTTONLIST",		AT_BUTTONLIST },
	{ L"COLOR_CYAN",		AT_COLOR_CYAN },
	{ L"COLOR_MAGENTA",		AT_COLOR_MAGENTA },
	{ L"COLOR_YELLOW",		AT_COLOR_YELLOW },
	{ L"COLOR_RED",			AT_COLOR_RED },
	{ L"COLOR_GREEN",		AT_COLOR_GREEN },
	{ L"COLOR_BLUE",		AT_COLOR_BLUE },
	{ L"BATTLE_CHARACTER",	AT_BATTLE_CHARACTER }
};
...
map<unsigned int, SortedChoiceItemScriptOpcode> HADES_STRING_SCRIPT_OPCODE = {
	...
	{ 0x36, { 0x36, L"TurnInstant", L"Make the character face an angle.\n\n1st argument: angle.\n0 faces south, 64 faces west, 128 faces north and 192 faces east.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Angle" }, new uint8_t[1]{ AT_ANGLE }, 0 } },
	...
	{ 0x43, { 0x43, L"RunSharedScript", L"Run script passing the current object to it and continue executing the current function.\nOnly one of such script can be executed by a specific entry at a time (eg. don't use that line twice in a row in the same function without waiting for the shared script to end in-between).\n\n1st argument: entry (should be a one-function entry).", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Entry" }, new uint8_t[1]{ AT_ENTRY }, 0 } },
	...
	{ 0x87, { 0x87, L"TurnInstantEx", L"Make the specified character face an angle.\n\n1st argument: object to turn.\n2nd argument: angle.\n0 faces south, 64 faces west, 128 faces north and 192 faces east.", true, 2, new uint8_t[2]{ 1, 1 }, new wstring[2]{ L"Entry", L"Angle" }, new uint8_t[2]{ AT_ENTRY, AT_ANGLE }, 0 } },
	...
	{ 0xBB, { 0xBB, L"TimedTurnEx", L"Make an object face an angle (animated).\n\n1st argument: object's entry.\n2nd argument: angle.\n0 faces south, 64 faces west, 128 faces north and 192 faces east.\n3rd argument: turn speed (1 is slowest).", true, 3, new uint8_t[3]{ 1, 1, 1 }, new wstring[3]{ L"Object", L"Angle", L"Speed" }, new uint8_t[3]{ AT_ENTRY, AT_ANGLE, AT_USPIN }, 0 } },
...
//	{ VARCODE_ENGINE,  208,	L"",		L"." },		Maybe GetHeight on the floor
	...
	// Note: The CheatEngine address for "General_ScenarioCounter" in the PSX version seems to be 0x7AEF0
	// The addresses of the consecutive variables are thus that address + the number associated, eg. "Chocobo_PepperSpotFound" is 0x7AFA6 (0x7AEF0 + 182)
	...
	{ VARCODE_UINT8,     5,	L"Progress_QuinaJoinTime",	L"Variable keeping track of the moment Quina has joined the team:\n0 = Not recruited yet\n3 = Recruited before going to Cleyra\n5 = Recruited for the journey to the Outer Continent" },
	{ VARCODE_UINT8,     6,	L"Setting_PartyNamed",		L"Bit flags checking which characters were given a name by the player." },
	{ VARCODE_UINT8,     7,	L"Setting_InnCostFactor",	L"A multiplier for the cost of resting in the different inns of the game; it is x0 until the first visit to a inn and then stays at x1 (for a cost of 100 gil or 120 gil depending on the inn)." },
	{ VARCODE_UINT8,     8,	L"Field_MusicVolume",		L"Volume of the Field music." },
	{ VARCODE_INT16,     9,	L"Field_AmbientSoundID1",	L"Numerical ID of the current field's ambient sound ('Play Sound Res') on the 1st ambient sound channel." },
	{ VARCODE_INT16,    11,	L"Field_AmbientSoundID2",	L"Numerical ID of the current field's ambient sound on the 2nd ambient sound channel." },
	{ VARCODE_UINT8,    13,	L"Field_AmbientSoundState1",L"State of the ambient sound on the 1st channel:\n0 = No ambient sound\n1 = Ambient sound loading\n2 = Ambient sound playing\n3 = Ambient sound stopping\n9 = Error trying to use a busy ambient sound channel" },
	{ VARCODE_UINT8,    14,	L"Field_AmbientSoundState2",L"State of the ambient sound on the 2nd channel:\n0 = No ambient sound\n1 = Ambient sound loading\n2 = Ambient sound playing\n3 = Ambient sound stopping\n9 = Error trying to use a busy ambient sound channel" },
//	{ VARCODE_UINT8,    15,	L"Setting_Unused",			L"Unused variable." },
	...
	{ VARCODE_BOOL,    189,	L"General_TentRest",		L"Flag checking if the current state is the player party resting in a tent (and thus all other objects are hidden)." },
//	{ VARCODE_BOOL,    191,	L"General_ZeroFlag",		L"Flag set back to 0 at the initialisation of each field." },
	{ VARCODE_BOOL,    196,	L"World_NarcissDockedAlexandria", L"Flag checking if the Blue Narciss is docked at Alexandria's harbor." },
	{ VARCODE_BOOL,    197,	L"World_InvicibleDocked",	L"Flag checking if the Invincible is docked at Lindblum's airship dock." },
	{ VARCODE_BOOL,    198,	L"World_HildaGardeDocked",	L"Flag checking if the Hilda Garde III is docked at Lindblum's airship dock." },
	{ VARCODE_BOOL,    199,	L"World_NarcissDockedLindblum", L"Flag checking if the Blue Narciss is docked at Lindblum's harbor." },
//	{ VARCODE_UINT8,    24,	L"World_CloseLocationFoot" }, // Those are Glob variables, not Gen
...
//	{ VARCODE_UINT8,    39,	L"World_CloseLocation" },
	...
	{ VARCODE_LUINT16, 314,	L"Festival_ZidaneScore",	L"The points of Zidane during the Festival of the Hunt." },
	{ VARCODE_LUINT16, 316,	L"Festival_LeaderScore",	L"The points of the leader/winner of the Festival of the Hunt." },
//	{ VARCODE_LBOOL,   324,	L"Setting_AllowPartySwitch",L"." },
	{ VARCODE_LUINT16, 333,	L"Festival_ViviScore",		L"The points of Vivi during the Festival of the Hunt." },
	{ VARCODE_LUINT16, 335,	L"Festival_FreyaScore",		L"The points of Freya during the Festival of the Hunt." },
...
//	{ VARCODE_LBOOL,   856,	L"Chocobo_BeachVisitedArea4",	L"Flag checking if the beach in area ID 4 has been visited." },
	{ VARCODE_LBOOL,   888,	L"Chocobo_MaxPoints",		L"Flag checking if the Hot & Cold points ever reached 99999." },
	...
	{ VARCODE_LUINT8, 1032, L"Mognet_LetterDeliveredCount",	L"Number of Mognet letters delivered by the player; the letters that moogles received by other means don't count." },
	...
	{ VARCODE_LBOOL,  3546,	L"Progress_StrangePotion",	L"Flag checking if self-proclaimed Artist Michael has been asked about the Strange Potion in his studio." },
	...
	{ VARCODE_LBOOL,  7684,	L"Treasure_ProtectRingArtemicion", L"Flag checking if Artemicion rewarded the player with a Protect Ring." },
...
vector<wstring> ScriptFieldAccessType = {
	L"no access:		",
	L"access:		",
	L"modify:		",
	L"access/modify:	"
...
vector<ConstantFieldNames> ScriptCharacterField = {
	{ 32, L"PRESENCE_ON", 2 },
	{ 33, L"PRESENCE_OFF", 2 },
	{ 34, L"PREVENT_ATTACK", 2 },
	{ 35, L"MAX_HP", 3 },
	{ 36, L"HP", 3 },
	{ 37, L"MAX_MP", 3 },
	{ 38, L"MP", 3 },
	...
	{ 40, L"ATB", 3 },
	{ 41, L"LEVEL", 1 },
	{ 42, L"STATUS_IMMUNE_B", 3 },
	{ 43, L"STATUS_IMMUNE_A", 3 },
	{ 44, L"STATUS_AUTO_B", 3 },
	{ 45, L"STATUS_AUTO_A", 3 },
	{ 46, L"STATUS_CURRENT_B", 3 },
	{ 47, L"STATUS_CURRENT_A", 3 },
	{ 48, L"ELEMENT_IMMUNE", 3 },
	{ 49, L"ELEMENT_ABSORB", 3 },
	{ 50, L"ELEMENT_HALF", 3 },
	{ 51, L"ELEMENT_WEAK", 3 },
	{ 52, L"TARGETABLE", 3 },
	{ 53, L"DISAPPEAR", 3 },
	...
	{ 56, L"RESET_SIZE", 2 },
	{ 57, L"MODEL", 1 },
	{ 58, L"MODEL_VISIBLE", 1 },
	{ 59, L"MODEL_OFF", 2 },
	{ 60, L"MODEL_ON", 2 },
	{ 61, L"PLAY_ANIM", 2 },
	{ 62, L"STOP_ANIM", 2 },
	{ 63, L"PLAY_ANIM_ONCE", 2 },
	{ 64, L"ROW", 1 },
	{ 65, L"COLUMN", 1 },
	{ 66, L"MODEL_TYPE", 1 },
	{ 67, L"CATEGORY", 1 },
	{ 68, L"CLASS", 1 },
	{ 69, L"STAND_ANIMATION", 3 },
	{ 70, L"ENEMY_ID", 1 },
	{ 71, L"DEFEATED_ON", 2 },
	{ 72, L"STRENGTH", 3 },
	{ 73, L"MAGIC", 3 },
	{ 74, L"DEFENCE", 3 },
	{ 75, L"EVADE", 3 },
	{ 76, L"MAGIC_DEFENCE", 3 },
	{ 77, L"MAGIC_EVADE", 3 },
	{ 78, L"MARTHYM_ON", 2 }
};

vector<ConstantFieldNames> ScriptCharacterFieldMemoria = {
	{ 100, L"ITEM_STEAL_1", 3 },
	{ 101, L"ITEM_STEAL_2", 3 },
	{ 102, L"ITEM_STEAL_3", 3 },
	{ 103, L"ITEM_STEAL_4", 3 },
	{ 104, L"ITEM_DROP_1", 3 },
	{ 105, L"ITEM_DROP_2", 3 },
	{ 106, L"ITEM_DROP_3", 3 },
	{ 107, L"ITEM_DROP_4", 3 },
	{ 108, L"CARD_DROP", 3 },
	{ 109, L"ENEMY_FLAGS", 3 },
	{ 110, L"OUT_OF_REACH", 3 },
	{ 111, L"MODEL_ALPHA", 3 },
	{ 112, L"CURRENT_ANIM", 3 },
//	{ 113, L"CLASS_EX", 3 }, // Should probably be merged with CLASS (68)
	{ 114, L"CURRENT_ATTACK", 3 },
	{ 140, L"POSITION_X", 3 },
	{ 141, L"POSITION_Z", 3 },
	{ 142, L"POSITION_Y", 3 },
	{ 143, L"FACING_ANGLE_X", 3 },
	{ 144, L"FACING_ANGLE_Z", 3 },
	{ 145, L"FACING_ANGLE_Y", 3 },
	{ 146, L"EXP_DROP", 3 },
	{ 147, L"GIL_DROP", 3 },
	{ 148, L"TRANCE", 3 },
	{ 149, L"HAS_TRANCE", 1 }
...
vector<ConstantNames> SoundCodeName = {
	...
	{ 53440, L"Play Sound Res channel 2" },
