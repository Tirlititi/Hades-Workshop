...
static SortedChoiceItemScriptOpcode HADES_STRING_SCRIPT_OPCODE[] = {
	...
	{ 0xA3, L"0xA3", L"Unknown Opcode.", true, 4, new uint8_t[4]{ 1, 1, 1, 1 }, new wstring[4]{ L"Unknown", L"Unknown", L"Unknown", L"Unknown" }, new uint8_t[4]{ AT_SPIN, AT_SPIN, AT_SPIN, AT_SPIN }, 0 }, // DRADIUS ; Unused in Steam
