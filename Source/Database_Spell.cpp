...
vector<SortedChoiceItemWithHelp> HADES_STRING_SPELL_EFFECT = {
	...
	{ 2, L"Attack Thief Sword", L"Thief swords and Knight swords attack.\nDamage = (Attack - Defence) * (Random[(Strength + Spirit) / 2, (Strength + Spirit) / 2 + (Level + Strength) / 8]\nHit Rate = 100\nCritical Rate = (Spirit / 4 - 1) / 200\n\nDamage Modifiers\n Caster : Killer Abilities, MP Attack, Healer, Berserk, Trance, Mini, Back Row and Elemental Boost (Weapon)\n Target : Defend, Protect, Sleep, Mini, Back Attack, Back Row, Gamble Defence and Elemental Affinity (Weapon)\n Other : Ipsen's Curse\nHit Rate Modifiers\n Caster : Accuracy+, Confuse, Blind, Trance and Vanish\n Target : Distract, Defend, Vanish, Petrify, Venom, Virus, Blind, Confuse, Stop, Sleep and Freeze\nUse physical evasion.\nKill Frozen targets.\nSpread damage if the target is under Trouble.\nAdd weapon's status with Add Status (use weapon's status accuracy)." },
	{ 3, L"Attack Rackets", L"Rackets attack.\nDamage = (Attack - Defence) * (Random[(Strength + Speed) / 2, (Strength + Speed) / 2 + (Level + Strength) / 8)\nHit Rate = 100\nCritical Rate = (Spirit / 4 - 1) / 200\n\nDamage Modifiers\n Caster : Killer Abilities, MP Attack, Healer, Berserk, Trance, Mini, Back Row and Elemental Boost (Weapon)\n Target : Defend, Protect, Sleep, Mini, Back Attack, Back Row, Gamble Defence and Elemental Affinity (Weapon)\n Other : Ipsen's Curse\nHit Rate Modifiers\n Caster : Accuracy+, Confuse, Blind, Trance and Vanish\n Target : Distract, Defend, Vanish, Petrify, Venom, Virus, Blind, Confuse, Stop, Sleep and Freeze\nUse physical evasion.\nKill Frozen targets.\nSpread damage if the target is under Trouble.\nAdd weapon's status with Add Status (use weapon's status accuracy)." },
	{ 4, L"Attack Scrolls", L"Magical weapons attack.\nDamage = (Attack - Defence) * (Random[(Strength + Magic) / 2, (Strength + Magic) / 2 + (Level + Strength) / 8]\nHit Rate = 100\nCritical Rate = (Spirit / 4 - 1) / 200\n\nDamage Modifiers\n Caster : Killer Abilities, MP Attack, Healer, Berserk, Trance, Mini, Back Row and Elemental Boost (Weapon)\n Target : Defend, Protect, Sleep, Mini, Back Attack, Back Row, Gamble Defence and Elemental Affinity (Weapon)\n Other : Ipsen's Curse\nHit Rate Modifiers\n Caster : Accuracy+, Confuse, Blind, Trance and Vanish\n Target : Distract, Defend, Vanish, Petrify, Venom, Virus, Blind, Confuse, Stop, Sleep and Freeze\nUse physical evasion.\nKill Frozen targets.\nSpread damage if the target is under Trouble.\nAdd weapon's status with Add Status (use weapon's status accuracy)." },
	{ 5, L"Attack Forks", L"Forks and Hammers attack.\nDamage = (Attack - Defence) * (Random[0, Strength - 1] + Random[0, (Level + Strength) / 8])\nHit Rate = 100\nCritical Rate = (Spirit / 4 - 1) / 200\n\nDamage Modifiers\n Caster : Killer Abilities, MP Attack, Healer, Berserk, Trance, Mini, Back Row and Elemental Boost (Weapon)\n Target : Defend, Protect, Sleep, Mini, Back Attack, Back Row, Gamble Defence and Elemental Affinity (Weapon)\n Other : Ipsen's Curse\nHit Rate Modifiers\n Caster : Accuracy+, Confuse, Blind, Trance and Vanish\n Target : Distract, Defend, Vanish, Petrify, Venom, Virus, Blind, Confuse, Stop, Sleep and Freeze\nUse physical evasion.\nKill Frozen targets.\nSpread damage if the target is under Trouble.\nAdd weapon's status with Add Status (use weapon's status accuracy)." },
	...
	{ 38, L"Spare Change", L"Type free attack using gil.\nLost Gil = Level * Power.\nDamage = (LostGil * LostGil * Spirit) / (TotalGil * 10)\n\nDamage is spread between the targets." },
...
vector<SortedChoiceItem> HADES_STRING_STATUS_PACK = {
...
vector<wxString> HADES_STRING_STATUS = {
	L"Petrify",
	L"Venom",
	L"Virus",
	L"Silence",
