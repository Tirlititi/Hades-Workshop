...
static SortedChoiceItemTextOpcode HADES_STRING_TEXT_OPCODE[] = {
	...
	{ 0x0A, L"DISPLAY_PROGRESSIVE", L"", L"Counter the effect of DISPLAY_INSTANT", 0, 0, NULL },
...
static SortedChoiceItemTextSteamOpcode HADES_STRING_TEXT_STEAM_OPCODE[] = {
	...
	{ L"SPED",	0,	HADES_STRING_TEXT_OPCODE[2].help,			L"" },
	...
	{ L"KCBT",	1,	L"Replaced by a keyboard button icon (ignored on mobile platforms)\n - Button name among START/SELECT/UP/DOWN/LEFT/RIGHT/CROSS/SQUARE/CIRCLE/TRIANGLE/L1/L2/R1/R2",	L"Key" },
	{ L"JCBT",	1,	L"Replaced by a joystick button icon (ignored on mobile platforms)\n - Button name among START/SELECT/UP/DOWN/LEFT/RIGHT/CROSS/SQUARE/CIRCLE/TRIANGLE/L1/L2/R1/R2",	L"Button" },
	{ L"url",	1,	L"Add an internet URL inside the [url=...][/url] tag",	L"" },
	...
	{ L"sub",	0,	L"Subscript the text inside the [sub][/sub] tag",	L"" },
	{ L"sup",	0,	L"Superscript the text inside the [sup][/sup] tag",	L"" }
};
