...
static SortedChoiceItemScriptOpcode HADES_STRING_SCRIPT_OPCODE[] = {
	...
	{ 0x10, L"RunScriptAsync", L"Run script function and continue executing the current one.\n\n1st argument : script level.\n2nd argument : entry of the function.\n3rd argument : function.", true, 3, new uint8_t[3]{ 1, 1, 1 }, new wstring[3]{ L"Script Level", L"Entry", L"Function" }, new uint8_t[3]{ AT_SPIN, AT_ENTRY, AT_FUNCTION }, 0 },
	{ 0x11, L"0x11", L"Unused Opcode.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x12, L"RunScript", L"Run script function and continue executing the current one.\n\n1st argument : script level.\n2nd argument : entry of the function.\n3rd argument : function.", true, 3, new uint8_t[3]{ 1, 1, 1 }, new wstring[3]{ L"Script Level", L"Entry", L"Function" }, new uint8_t[3]{ AT_SPIN, AT_ENTRY, AT_FUNCTION }, 0 },
	{ 0x13, L"0x13", L"Unused Opcode.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x14, L"RunScriptSync", L"Run script function and wait until it returns.\n\n1st argument : script level.\n2nd argument : entry of the function.\n3rd argument : function.", true, 3, new uint8_t[3]{ 1, 1, 1 }, new wstring[3]{ L"Script Level", L"Entry", L"Function" }, new uint8_t[3]{ AT_SPIN, AT_ENTRY, AT_FUNCTION }, 0 },
	{ 0x15, L"0x15", L"Unused Opcode.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x16, L"RunScriptObjectAsync", L"Run script function and continue executing the current one. Must only be used in response to a function call ; the argument's entry is the one that called this function.\n\n1st argument : script level.\n2nd argument : function.", true, 2, new uint8_t[2]{ 1, 1 }, new wstring[2]{ L"Script Level", L"Function" }, new uint8_t[2]{ AT_SPIN, AT_FUNCTION }, 0 },
	{ 0x17, L"0x17", L"Unused Opcode.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x18, L"RunScriptObject", L"Run script function and continue executing the current one. Must only be used in response to a function call ; the argument's entry is the one that called this function.\n\n1st argument : script level.\n2nd argument : function.", true, 2, new uint8_t[2]{ 1, 1 }, new wstring[2]{ L"Script Level", L"Function" }, new uint8_t[2]{ AT_SPIN, AT_FUNCTION }, 0 },
	{ 0x19, L"0x19", L"Unused Opcode.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x1A, L"RunScriptObjectSync", L"Run script function and wait until it returns. Must only be used in response to a function call ; the argument's entry is the one that called this function.\n\n1st argument : script level.\n2nd argument : function.", true, 2, new uint8_t[2]{ 1, 1 }, new wstring[2]{ L"Script Level", L"Function" }, new uint8_t[2]{ AT_SPIN, AT_FUNCTION }, 0 },
	...
	{ 0x24, L"WalkTowardObject", L"Make the character walk and follow an object.\n\n1st argument : object to walk toward.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Object" }, new uint8_t[1]{ AT_USPIN }, 0 },
	...
	{ 0x3B, L"SetObjectIndex", L"Redefine the current object's ID.1st argument : new ID.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"ID" }, new uint8_t[1]{ AT_SPIN }, 0 },
	{ 0x3C, L"SetRandomBattles", L"Define random battles.\n\n1st argument : pattern (unknown).\n2nd to 5th arguments : random battles possible.", true, 5, new uint8_t[5]{ 1, 2, 2, 2, 2 }, new wstring[5]{ L"Pattern", L"Battle 1", L"Battle 2", L"Battle 3", L"Battle 4" }, new uint8_t[5]{ AT_SPIN, AT_BATTLE, AT_BATTLE, AT_BATTLE, AT_BATTLE }, 0 },
	...
	{ 0x53, L"0x53", L"Seems to prevent new windows to close older ones.", false, 0, NULL, NULL, NULL, 0 },
	{ 0x54, L"WaitWindow", L"Wait until the window is closed.\n\n1st argument : window ID determined at its creation.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Window ID" }, new uint8_t[1]{ AT_USPIN }, 0 },
	{ 0x55, L"0x55", L"Unknown Opcode.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Unknown" }, new uint8_t[1]{ AT_USPIN }, 0 }, // actor.omega = arg:
	...
	{ 0x7D, L"RunTimer", L"Pause or resume the timer window.\n\n1st argument : boolean run/pause.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Run" }, new uint8_t[1]{ AT_USPIN }, 0 }, // Surely AT_BOOL
	...
	{ 0x91, L"0x91", L"Unknown Opcode.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Unknown" }, new uint8_t[1]{ AT_BOOL }, 0 }, // AUTOTURN
	...
	{ 0x97, L"0x97", L"Unknown Opcode.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Unknown" }, new uint8_t[1]{ AT_ENTRY }, 0 }, // DRET
	...
	{ 0xA3, L"0xA3", L"Unknown Opcode.", true, 4, new uint8_t[4]{ 1, 1, 1, 1 }, new wstring[4]{ L"Unknown", L"Unknown", L"Unknown", L"Unknown" }, new uint8_t[4]{ AT_SPIN, AT_SPIN, AT_SPIN, AT_SPIN }, 0 },
	...
	{ 0xA6, L"0xA6", L"Unknown Opcode.", true, 1, new uint8_t[1]{ 1 }, new wstring[1]{ L"Unknown" }, new uint8_t[1]{ AT_USPIN }, 0 }, // SPEEDTH
	...
	{ 0xB3, L"0xB3", L"Unknown Opcode.", true, 5, new uint8_t[5]{ 1, 1, 2, 2, 2 }, new wstring[3]{ L"Unknown", L"Unknown", L"Coordinates" }, new uint8_t[5]{ AT_SPIN, AT_SPIN, AT_POSITION_X, AT_POSITION_Z, AT_POSITION_Y }, 0 }, // Sps Parameter
	...
	{ 0xB9, L"AddControllerMask", L"Prevent the input to be processed by the game.\n\n1st argument : unknown.\n2nd argument : button list.\n1 : Select\n4 : Start\n5 : Up\n6 : Right\n7 : Down\n8 : Left\n9 : L2\n10 : R2\n11 : L1\n12 : R1\n13 : Triangle\n14 : Circle\n15 : Cross\n16 : Square\n17 : Cancel\n18 : Confirm\n20 : Moogle\n21 : L1 Ex\n22 : R1 Ex\n23 : L2 Ex\n24 : R2 Ex\n25 : Menu\n26 : Select Ex", true, 2, new uint8_t[2]{ 1, 2 }, new wstring[2]{ L"Unknown", L"Buttons" }, new uint8_t[2]{ AT_SPIN, AT_BOOLLIST }, 0 },
	...
	{ 0xC4, L"RunGameCode", L"Run a game code, which effects have a large range. May modify the weather, the music, call the chocobo or enable the auto-pilot.\n\n1st argument : game code.\n2nd argument : depends on the code.", true, 2, new uint8_t[2]{ 1, 2 }, new wstring[2]{ L"Code", L"Argument" }, new uint8_t[2]{ AT_GAMECODE, AT_SPIN }, 0 },
	...
	{ 0xDA, L"0xDA", L"Unknown Opcode.", true, 5, new uint8_t[5]{ 1, 1, 1, 2, 2 }, new wstring[5]{ L"Unknown", L"Unknown", L"Unknown", L"Unknown", L"Unknown" }, new uint8_t[5]{ AT_SPIN, AT_SPIN, AT_SPIN, AT_SPIN, AT_SPIN }, 0 }, // Exactly the same as 0xB3
