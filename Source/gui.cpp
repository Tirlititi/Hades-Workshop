...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_editsimilarenemy = new wxMenuItem( m_menuOption, wxID_ANY, wxString( _("Edit Similar &Enemies") ) + wxT('\t') + wxT("Ctrl+D"), _("Edit stats and attacks of enemies sharing the same name and level"), wxITEM_CHECK );
	...
	m_randomizer = new wxMenuItem( m_menuTools, wxID_RANDOMIZER, wxString( _("Randomizer") ) , _("Randomize or shuffle various datas"), wxITEM_NORMAL );
	...
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnOpenClick ), this, m_open->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnOpenHWSClick ), this, m_openhws->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnCloseClick ), this, m_close->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnCloseAllClick ), this, m_closeall->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnSaveHWSClick ), this, m_savehws->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnSaveSteamClick ), this, m_savesteam->GetId());
	m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnExportPPFClick ), this, m_exportppf->GetId());
	...
	m_menuOption->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnSortWorldClick ), this, m_sortworld->GetId());
	...
	m_menuBatch->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnBatchImportClick ), this, m_importworldscript->GetId());
...
CDPanel::CDPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	wxBoxSizer* bSizer7;
	...
	gSizer212 = new wxGridSizer( 1, 4, 0, 0 );

	m_spellmenuflag1 = new wxCheckBox( m_spellscrolledwindow, wxID_MF1, _("Can use in Menu"), wxDefaultPosition, wxDefaultSize, 0 );
	m_spellmenuflag1->SetToolTip( _("The effect must be compatible") );

	gSizer212->Add( m_spellmenuflag1, 0, wxALL, 5 );

	m_spellmenuflag2 = new wxCheckBox( m_spellscrolledwindow, wxID_MF2, _("Hide AP figures"), wxDefaultPosition, wxDefaultSize, 0 );
	m_spellmenuflag2->SetToolTip( _("Hide the AP figures in menu but not the progression bar") );

	gSizer212->Add( m_spellmenuflag2, 0, wxALL, 5 );

	m_spellmenuflag3 = new wxCheckBox( m_spellscrolledwindow, wxID_MF3, _("MP x 4"), wxDefaultPosition, wxDefaultSize, 0 );
	m_spellmenuflag3->SetToolTip( _("Boost the MP cost early game") );
	...
	gSizer212->Add( m_spellmenuflag5, 0, wxALL, 5 );

	m_spellmenuflag6 = new wxCheckBox( m_spellscrolledwindow, wxID_MF6, _("Unused (6)"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer212->Add( m_spellmenuflag6, 0, wxALL, 5 );

	m_spellmenuflag7 = new wxCheckBox( m_spellscrolledwindow, wxID_MF7, _("Unused (7)"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer212->Add( m_spellmenuflag7, 0, wxALL, 5 );

	m_spellmenuflag8 = new wxCheckBox( m_spellscrolledwindow, wxID_MF8, _("Enemy Attack"), wxDefaultPosition, wxDefaultSize, 0 );
	m_spellmenuflag8->SetToolTip( _("Dummied") );

	gSizer212->Add( m_spellmenuflag8, 0, wxALL, 5 );
	...
	wxString m_spelltargettypeChoices[] = { _("Any"), _("Ally"), _("Enemy"), _("Everyone"), _("Self"), _("Irrelevant") };
	...
	wxString m_spelltargetamountChoices[] = { _("Single"), _("Multiple"), _("Single-Multi"), _("Multiple (Special)") };
	...
	m_spelltargetamount->SetToolTip( _("In Steam, a bug makes \"Any Multiple\" and \"Any Multiple (Special)\" be considered as \"Everyone\"") );
	...
	m_cmdmovespellup = new wxBitmapButton( m_cmdspelllistpanel, wxID_UP, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_cmdmovespellup->SetBitmap( wxICON( moveup_icon ) );
	m_cmdmovespellup->SetBitmapDisabled( wxICON( moveup_disicon ) );
	bSizer89111->Add( m_cmdmovespellup, 0, wxALL, 5 );

	m_cmdmovespelldown = new wxBitmapButton( m_cmdspelllistpanel, wxID_DOWN, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_cmdmovespelldown->SetBitmap( wxICON( movedown_icon ) );
	...
	m_itemmenuposbuttonup = new wxBitmapButton( m_itemscrolledwindow, wxID_MENUPOSUP, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_itemmenuposbuttonup->SetBitmap( wxICON( moveup_icon ) );
	m_itemmenuposbuttonup->SetBitmapDisabled( wxICON( moveup_disicon ) );
	bSizer89->Add( m_itemmenuposbuttonup, 0, wxALL, 5 );

	m_itemmenuposbuttondown = new wxBitmapButton( m_itemscrolledwindow, wxID_MENUPOSDOWN, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_itemmenuposbuttondown->SetBitmap( wxICON( movedown_icon ) );
	...
	m_itemequipposbuttonup = new wxBitmapButton( m_itemscrolledwindow, wxID_EQUIPPOSUP, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_itemequipposbuttonup->SetBitmap( wxICON( moveup_icon ) );
	m_itemequipposbuttonup->SetBitmapDisabled( wxICON( moveup_disicon ) );
	bSizer891->Add( m_itemequipposbuttonup, 0, wxALL, 5 );

	m_itemequipposbuttondown = new wxBitmapButton( m_itemscrolledwindow, wxID_EQUIPPOSDOWN, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_itemequipposbuttondown->SetBitmap( wxICON( movedown_icon ) );
	...
	m_staticText397 = new wxStaticText( m_itemscrolledwindow, wxID_ANY, _("Unused"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText397->Wrap( -1 );
	fgSizer511->Add( m_staticText397, 0, wxALL, 5 );

	m_itemzero = new wxSpinCtrl( m_itemscrolledwindow, wxID_ZERO, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 255, 0 );
	m_itemzero->SetToolTip( _("Dummied data (may have a custom use by modding the engine)") );

	fgSizer511->Add( m_itemzero, 0, wxALL, 2 );
	...
	wxString m_itemusabletargettypeChoices[] = { _("Any"), _("Ally"), _("Enemy"), _("Everyone"), _("Self"), _("Irrelevant") };
	...
	wxString m_itemusabletargetamountChoices[] = { _("Single"), _("Multiple"), _("Single-Multi"), _("Multiple (Special)") };
	...
	m_itemusabletargetamount->SetToolTip( _("In Steam, a bug makes \"Any Multiple\" and \"Any Multiple (Special)\" be considered as \"Everyone\"") );
	...
	m_itemweaponflag5 = new wxCheckBox( m_itemweaponpanel, wxID_WF5, _("Unused (5)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_itemweaponflag->Add( m_itemweaponflag5, 0, wxALL, 5 );

	m_itemweaponflag6 = new wxCheckBox( m_itemweaponpanel, wxID_WF6, _("Unused (6)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_itemweaponflag->Add( m_itemweaponflag6, 0, wxALL, 5 );

	m_itemweaponflag7 = new wxCheckBox( m_itemweaponpanel, wxID_WF7, _("Unused (7)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_itemweaponflag->Add( m_itemweaponflag7, 0, wxALL, 5 );

	m_itemweaponflag8 = new wxCheckBox( m_itemweaponpanel, wxID_WF8, _("Unused (8)"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_shopmoveitemup = new wxBitmapButton( m_shopitemlistpanel, wxID_UP, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_shopmoveitemup->SetBitmap( wxICON( moveup_icon ) );
	m_shopmoveitemup->SetBitmapDisabled( wxICON( moveup_disicon ) );
	bSizer89112->Add( m_shopmoveitemup, 0, wxALL, 5 );

	m_shopmoveitemdown = new wxBitmapButton( m_shopitemlistpanel, wxID_DOWN, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_shopmoveitemdown->SetBitmap( wxICON( movedown_icon ) );
	...
	m_staticText391 = new wxStaticText( m_enemystatpanel1, wxID_ANY, _("Death Flags"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText391->Wrap( -1 );
	fgSizer9->Add( m_staticText391, 0, wxALL, 5 );

	wxGridSizer* m_enemydeathflags;
	m_enemydeathflags = new wxGridSizer( 2, 4, 0, 0 );

	m_enemydeathflag1 = new wxCheckBox( m_enemystatpanel1, wxID_ED1, _("Death Script"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflag1->SetToolTip( _("Run the \"Death\" function when reaching 0 HP") );

	m_enemydeathflags->Add( m_enemydeathflag1, 0, wxALL, 5 );

	m_enemydeathflag2 = new wxCheckBox( m_enemystatpanel1, wxID_ED2, _("Unknown"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflag2->SetToolTip( _("die_dmg") );

	m_enemydeathflags->Add( m_enemydeathflag2, 0, wxALL, 5 );

	m_enemydeathflag3 = new wxCheckBox( m_enemystatpanel1, wxID_ED3, _("Unused (3)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag3, 0, wxALL, 5 );

	m_enemydeathflag4 = new wxCheckBox( m_enemystatpanel1, wxID_ED4, _("Unused (4)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag4, 0, wxALL, 5 );

	m_enemydeathflag5 = new wxCheckBox( m_enemystatpanel1, wxID_ED5, _("Unused (5)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag5, 0, wxALL, 5 );

	m_enemydeathflag6 = new wxCheckBox( m_enemystatpanel1, wxID_ED6, _("Unused (6)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag6, 0, wxALL, 5 );

	m_enemydeathflag7 = new wxCheckBox( m_enemystatpanel1, wxID_ED7, _("Unused (7)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag7, 0, wxALL, 5 );

	m_enemydeathflag8 = new wxCheckBox( m_enemystatpanel1, wxID_ED8, _("Unused (8)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enemydeathflags->Add( m_enemydeathflag8, 0, wxALL, 5 );


	fgSizer9->Add( m_enemydeathflags, 1, wxEXPAND, 5 );
	...
	m_staticText392 = new wxStaticText( m_enemystatpanel1, wxID_ANY, _("Unused (Stat)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText392->Wrap( -1 );
	fgSizer9->Add( m_staticText392, 0, wxALL, 5 );
	...
	m_staticText393 = new wxStaticText( m_enemystatpanel1, wxID_ANY, _("Unused (1)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText393->Wrap( -1 );
	fgSizer9->Add( m_staticText393, 0, wxALL, 5 );
	...
	m_staticText395 = new wxStaticText( m_enemystatpanel1, wxID_ANY, _("Unused (2)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText395->Wrap( -1 );
	fgSizer9->Add( m_staticText395, 0, wxALL, 5 );
	...
	m_staticText396 = new wxStaticText( m_enemystatpanel1, wxID_ANY, _("Unused (3)"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText396->Wrap( -1 );
	fgSizer9->Add( m_staticText396, 0, wxALL, 5 );
	...
	m_textcharmapwindow = new wxScrolledWindow( m_textscrolledwindow, wxID_TEXT, wxDefaultPosition, wxSize( 261,261 ), wxHSCROLL|wxVSCROLL|wxBORDER_SUNKEN );
	...
	m_worldtextcharmapwindow = new wxScrolledWindow( m_worldscrolledwindow, wxID_WORLD, wxDefaultPosition, wxSize( 261,261 ), wxHSCROLL|wxVSCROLL|wxBORDER_SUNKEN );
	...
	m_battlescenetexture = new wxScrolledWindow( m_battlescenescrolledwindow, wxID_ANY, wxDefaultPosition, wxSize( 261,261 ), wxHSCROLL|wxVSCROLL|wxBORDER_SUNKEN );
	...
	m_mipsbattleramposgen = new wxTextCtrl( m_mipsbattlegenscrolledwindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0|wxBORDER_SIMPLE );
	...
	m_mipsbattlerampos = new wxTextCtrl( m_mipsbattlescrolledwindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY|wxBORDER_SIMPLE );
	...
	m_cilmacrodescription = new wxTextCtrl( m_cilmacroscrolledwindow, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE|wxTE_READONLY|wxBORDER_SIMPLE );
	...
	m_spellmenuflag1->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag2->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag3->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag4->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag5->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag6->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag7->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag8->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	...
	m_itemzero->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnItemChangeSpin ), NULL, this );
	...
	m_enemydeathflag1->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag2->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag3->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag4->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag5->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag6->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag7->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag8->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	...
	m_enemystatzerostat->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero1->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero2->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero3->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
...
CDPanel::~CDPanel()
{
	...
	m_spellmenuflag1->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag2->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag3->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag4->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag5->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag6->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag7->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	m_spellmenuflag8->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnSpellChangeFlags ), NULL, this );
	...
	m_itemzero->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnItemChangeSpin ), NULL, this );
	...
	m_enemydeathflag1->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag2->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag3->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag4->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag5->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag6->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag7->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	m_enemydeathflag8->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( CDPanel::OnEnemyChangeFlags ), NULL, this );
	...
	m_enemystatzerostat->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero1->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero2->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
	m_enemystatzero3->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( CDPanel::OnEnemyChangeSpin ), NULL, this );
...
PreferencesWindow::PreferencesWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_backgroundresolution->SetToolTip( _("Expected resolution of the Field backgrounds\n32 is the default Steam resolution\nIt should be increased only if a background mod has been installed directly on the files that you open with Hades Workshop") );
...
IOHWSWindow::IOHWSWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_hwspicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Select a file"), _("Hades Workshop Save (*.hws)|*.hws"), wxDefaultPosition, wxSize( -1,-1 ), wxFLP_USE_TEXTCTRL );
...
ExportPPFWindow::ExportPPFWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_ppfpicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("Playstation Patch (*.ppf)|*.ppf"), wxDefaultPosition, wxSize( -1,-1 ), wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
...
SaveSteamWindow::SaveSteamWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText399 = new wxStaticText( this, wxID_ANY, _("Generated formats:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText399->Wrap( -1 );
	bSizer31->Add( m_staticText399, 0, 0, 5 );

	wxBoxSizer* bSizer216;
	bSizer216 = new wxBoxSizer( wxHORIZONTAL );

	wxString m_dllformatChoices[] = { _("Compiled DLL"), _("Spreadsheets (Memoria)"), _("C# Code Pieces") };
	int m_dllformatNChoices = sizeof( m_dllformatChoices ) / sizeof( wxString );
	m_dllformat = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_dllformatNChoices, m_dllformatChoices, 0 );
	m_dllformat->SetSelection( 0 );
	bSizer216->Add( m_dllformat, 0, wxALL|wxEXPAND, 5 );

	wxString m_assetformatChoices[] = { _("Unity Archives"), _("Raw Assets") };
	int m_assetformatNChoices = sizeof( m_assetformatChoices ) / sizeof( wxString );
	m_assetformat = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_assetformatNChoices, m_assetformatChoices, 0 );
	m_assetformat->SetSelection( 0 );
	bSizer216->Add( m_assetformat, 0, wxALL, 5 );


	bSizer31->Add( bSizer216, 1, wxEXPAND, 5 );
	...
	m_showinfobtn = new wxStaticBitmap( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( 16,16 ), 0 );
	fgSizer109->Add( m_showinfobtn, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_staticText398 = new wxStaticText( this, wxID_ANY, _("Additional Information"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText398->Wrap( -1 );
	fgSizer109->Add( m_staticText398, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );


	bSizer31->Add( fgSizer109, 1, wxEXPAND, 5 );

	m_infotext = new wxStaticText( this, wxID_ANY, _("  Choose the folder where to generate modded files.\n  DLL and Unity Archives are meant to directly replace the game's corresponding files.\n  Spreadsheets and Raw Assets are meant to be used in combination with the Memoria Engine Editor (made by Albeoris), by adding the folder with generated files to the field \"[Mod] FolderNames\" of Memoria.ini.\n  C# Code Pieces are meant to replace parts of the game's source code.\n  Raw Assets may also be imported inside Unity Archives using an archive editor (such as the Unity Assets Viewer available here as a tool).\n\n  Older mod files inside the target folder may be deleted in the process. The rules for these deletions are:\n - If the target folder's name is \"FINAL FANTASY IX\", nothing is deleted (the new files replace the old ones though),\n - Otherwise, all the files that could be generated using the selected formats are deleted before generating new ones,\n - The directories are not deleted, which may lead to a bunch of empty folders from previous mod saves; it is up to you to clean them.\n\n  Remember to also save your mods as HWS files (\"Save Mod\") as these files are more compact and easier to get back to."), wxDefaultPosition, wxDefaultSize, 0 );
	m_infotext->Wrap( 330 );
	m_infotext->Hide();

	bSizer31->Add( m_infotext, 0, wxALL, 5 );
	...
	// Connect Events
	m_showinfobtn->Connect( wxEVT_LEFT_DOWN, wxMouseEventHandler( SaveSteamWindow::OnShowHideInfo ), NULL, this );
}

SaveSteamWindow::~SaveSteamWindow()
{
	// Disconnect Events
	m_showinfobtn->Disconnect( wxEVT_LEFT_DOWN, wxMouseEventHandler( SaveSteamWindow::OnShowHideInfo ), NULL, this );
...
LogWindow::LogWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_errornum = new wxTextCtrl( this, wxID_ANY, _("Error(s) : "), wxDefaultPosition, wxDefaultSize, wxTE_READONLY|wxBORDER_NONE );
	...
	m_errorctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 200,80 ), wxHSCROLL|wxTE_MULTILINE|wxTE_READONLY );
	...
	m_warningnum = new wxTextCtrl( this, wxID_ANY, _("Warning(s) : "), wxDefaultPosition, wxDefaultSize, wxTE_READONLY|wxBORDER_NONE );
	...
	m_warningctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 200,80 ), wxHSCROLL|wxTE_MULTILINE|wxTE_READONLY );
...
TextEditWindow::TextEditWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_opcodeup = new wxBitmapButton( m_panel14, wxID_UP, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_opcodeup->SetBitmap( wxICON( moveup_icon ) );
	gbSizer6->Add( m_opcodeup, wxGBPosition( 1, 2 ), wxGBSpan( 1, 1 ), wxALL, 2 );

	m_opcodedown = new wxBitmapButton( m_panel14, wxID_DOWN, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_opcodedown->SetBitmap( wxICON( movedown_icon ) );
	...
	m_buttonbubble = new wxButton( this, wxID_BUBBLE, _("Bubble size :"), wxDefaultPosition, wxDefaultSize, wxBORDER_NONE );
	...
	m_richtextctrl = new PreviewTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 200,75 ), wxTE_READONLY|wxVSCROLL|wxHSCROLL|wxWANTS_CHARS|wxBORDER_NONE );
...
TextSteamEditWindow::TextSteamEditWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_buttonbubble = new wxButton( this, wxID_BUBBLE, _("Auto-Size"), wxDefaultPosition, wxDefaultSize, wxBORDER_NONE );
	...
	m_richtextctrl = new PreviewTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,160 ), wxTE_READONLY|wxHSCROLL|wxVSCROLL|wxWANTS_CHARS|wxBORDER_NONE );
	m_richtextctrl->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_APPWORKSPACE ) );
...
TextSteamHelpWindow::TextSteamHelpWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_helptextctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,-1 ), wxTE_MULTILINE|wxTE_READONLY|wxBORDER_SIMPLE );
...
TextExportWindow::TextExportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("Text files (*.txt)|*.txt"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
...
BatchExportWindow::BatchExportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("File Batch|*"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
BatchImportWindow::BatchImportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Load..."), _("File Batch|*"), wxDefaultPosition, wxDefaultSize, wxFLP_OPEN|wxFLP_USE_TEXTCTRL );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
CharmapTextureExportWindow::CharmapTextureExportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("Image (*.tga)|*.tga"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
FieldTextureExportWindow::FieldTextureExportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("Image (*.tiff)|*.tiff"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
BattleSceneExportWindow::BattleSceneExportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Save..."), _("Object file (*.obj)|*"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
BattleSceneImportWindow::BattleSceneImportWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Import..."), _("Object file (*.obj)|*.obj"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE );
	gbSizer2->Add( m_filepicker, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
...
BattleSceneImportLinkTextureWindow::BattleSceneImportLinkTextureWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_texturepanel = new wxScrolledWindow( this, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), wxHSCROLL|wxVSCROLL|wxBORDER_SUNKEN );
...
ManageTextureWindow::ManageTextureWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_drawpanelcolor = new wxPanel( m_modifypaneldraw, wxID_ANY, wxDefaultPosition, wxSize( 170,50 ), wxTAB_TRAVERSAL );
...
ScriptEditWindow::ScriptEditWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_helptextctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 260,150 ), wxTE_MULTILINE|wxTE_READONLY|wxBORDER_SIMPLE );
	m_helptextctrl->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INFOBK ) );
...
AnimSequenceEditWindow::AnimSequenceEditWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_helptextctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 150,-1 ), wxTE_MULTILINE|wxTE_NO_VSCROLL|wxTE_READONLY|wxBORDER_SIMPLE );
	m_helptextctrl->SetBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INFOBK ) );
...
CilScriptEditWindow::CilScriptEditWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_scriptposctrl = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxTE_MULTILINE|wxTE_NO_VSCROLL|wxTE_READONLY|wxBORDER_NONE );
...
ModManagerWindow::ModManagerWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_textCtrl55 = new wxTextCtrl( this, wxID_ANY, _("Here you can check and define which datas are labelled as \"modified\" and should be saved."), wxDefaultPosition, wxSize( -1,35 ), wxTE_MULTILINE|wxTE_NO_VSCROLL|wxTE_READONLY|wxBORDER_SIMPLE );
...
RandomizerWindow::RandomizerWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText403 = new wxStaticText( this, wxID_ANY, _("Options:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText403->Wrap( -1 );
	fgSizer110->Add( m_staticText403, 0, wxALL, 5 );

	wxFlexGridSizer* fgSizer120;
	fgSizer120 = new wxFlexGridSizer( 0, 6, 0, 0 );
	...
	fgSizer121 = new wxFlexGridSizer( 0, 3, 0, 0 );
	fgSizer121->SetFlexibleDirection( wxBOTH );
	fgSizer121->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_enableseed = new wxCheckBox( this, wxID_ANY, _("Choose Random Seed"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer121->Add( m_enableseed, 0, wxLEFT, 5 );

	m_staticText405 = new wxStaticText( this, wxID_ANY, _("Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText405->Wrap( -1 );
	fgSizer121->Add( m_staticText405, 0, wxLEFT, 5 );

	m_staticText406 = new wxStaticText( this, wxID_ANY, _("Load All Sections"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText406->Wrap( -1 );
	fgSizer121->Add( m_staticText406, 0, wxLEFT, 5 );

	m_seedctrl = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT|wxSP_ARROW_KEYS|wxSP_WRAP, 0, 16777215, 0 );
	m_seedctrl->SetToolTip( _("If all the settings are the same and if the random seed is the same, then two different randomizations will generate the same result") );

	fgSizer121->Add( m_seedctrl, 0, wxALL, 3 );

	m_safeabilbtn = new wxButton( this, wxID_SAFESET, _("Change"), wxDefaultPosition, wxDefaultSize, 0 );
	m_safeabilbtn->SetToolTip( _("Abilities to exclude from the various randomization processes") );

	fgSizer121->Add( m_safeabilbtn, 0, wxALL, 3 );

	m_loadallbtn = new wxButton( this, wxID_LOADALL, _("Load Datas"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer121->Add( m_loadallbtn, 0, wxALL, 3 );


	fgSizer120->Add( fgSizer121, 1, wxEXPAND, 5 );


	fgSizer110->Add( fgSizer120, 1, wxEXPAND, 5 );

	m_staticText397 = new wxStaticText( this, wxID_ANY, _("Sections:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText397->Wrap( -1 );
	fgSizer110->Add( m_staticText397, 0, wxALL, 5 );

	wxFlexGridSizer* fgSizer111;
	fgSizer111 = new wxFlexGridSizer( 0, 6, 0, 0 );
	fgSizer111->SetFlexibleDirection( wxBOTH );
	fgSizer111->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_enablechar = new wxCheckBox( this, wxID_ANY, _("Characters"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enablechar->SetValue(true);
	fgSizer111->Add( m_enablechar, 0, wxALL, 5 );

	m_enableweap = new wxCheckBox( this, wxID_ANY, _("Weapons"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enableweap->SetValue(true);
	fgSizer111->Add( m_enableweap, 0, wxALL, 5 );

	m_enablearmor = new wxCheckBox( this, wxID_ANY, _("Armors"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enablearmor->SetValue(true);
	fgSizer111->Add( m_enablearmor, 0, wxALL, 5 );

	m_enablebattle = new wxCheckBox( this, wxID_ANY, _("Enemies"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enablebattle->SetValue(true);
	fgSizer111->Add( m_enablebattle, 0, wxALL, 5 );

	m_enablecard = new wxCheckBox( this, wxID_ANY, _("Cards"), wxDefaultPosition, wxDefaultSize, 0 );
	m_enablecard->SetValue(true);
	fgSizer111->Add( m_enablecard, 0, wxALL, 5 );


	fgSizer110->Add( fgSizer111, 1, wxEXPAND, 5 );


	fgSizer85->Add( fgSizer110, 1, wxEXPAND, 5 );

	m_auinotebook5 = new wxAuiNotebook( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxAUI_NB_TOP );
	m_panelchar = new wxScrolledWindow( m_auinotebook5, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	m_panelchar->SetScrollRate( 5, 5 );
	...
	wxString m_charspellpowerChoices[] = { _("Keep Spell Powers"), _("Shuffle Spell Powers"), _("Randomize Spell Powers") };
	int m_charspellpowerNChoices = sizeof( m_charspellpowerChoices ) / sizeof( wxString );
	m_charspellpower = new wxChoice( m_panelchar, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_charspellpowerNChoices, m_charspellpowerChoices, 0 );
	m_charspellpower->SetSelection( 0 );
	m_charspellpower->SetToolTip( _("Shuffle: redistribute spell powers\nRandomize: assign random spell powers") );

	bSizer226->Add( m_charspellpower, 0, wxALL, 5 );

	wxString m_charspellstatusChoices[] = { _("Keep Spell Statuses"), _("Shuffle Spell Statuses"), _("Randomize Spell Statuses") };
	int m_charspellstatusNChoices = sizeof( m_charspellstatusChoices ) / sizeof( wxString );
	m_charspellstatus = new wxChoice( m_panelchar, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_charspellstatusNChoices, m_charspellstatusChoices, 0 );
	m_charspellstatus->SetSelection( 0 );
	m_charspellstatus->SetToolTip( _("Shuffle: redistribute spell statuses\nRandomize: assign random statuses") );

	bSizer226->Add( m_charspellstatus, 0, wxALL, 5 );

	m_charspellstatsafe = new wxCheckBox( m_panelchar, wxID_ANY, _("Exclude Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charspellstatsafe->SetValue(true);
	bSizer226->Add( m_charspellstatsafe, 0, wxALL, 5 );


	bSizer225->Add( bSizer226, 1, wxEXPAND, 5 );

	m_staticline5 = new wxStaticLine( m_panelchar, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	bSizer225->Add( m_staticline5, 0, wxEXPAND | wxALL, 5 );

	wxBoxSizer* bSizer227;
	bSizer227 = new wxBoxSizer( wxVERTICAL );

	m_charspell = new wxCheckBox( m_panelchar, wxID_CHARSPELL, _("Shuffle Spells"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charspell->SetValue(true);
	bSizer227->Add( m_charspell, 0, wxALL, 5 );

	wxString m_charmpboostChoices[] = { _("Remove MP x 4 flag"), _("MP x 4 flag on summons"), _("MP x 4 on Summon command") };
	int m_charmpboostNChoices = sizeof( m_charmpboostChoices ) / sizeof( wxString );
	m_charmpboost = new wxChoice( m_panelchar, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_charmpboostNChoices, m_charmpboostChoices, 0 );
	m_charmpboost->SetSelection( 2 );
	bSizer227->Add( m_charmpboost, 0, wxALL, 5 );

	m_charsummon = new wxCheckBox( m_panelchar, wxID_ANY, _("Shuffle Summons apart"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer227->Add( m_charsummon, 0, wxALL, 5 );

	wxBoxSizer* bSizer221;
	bSizer221 = new wxBoxSizer( wxVERTICAL );

	m_charquinaaplabel = new wxStaticText( m_panelchar, wxID_ANY, _("Quina AP needs:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charquinaaplabel->Wrap( -1 );
	bSizer221->Add( m_charquinaaplabel, 0, wxALL, 0 );

	m_charquinaap = new wxSpinCtrl( m_panelchar, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 255, 75 );
	m_charquinaap->SetToolTip( _("AP cost for learning the spells of Quina through equipements") );

	bSizer221->Add( m_charquinaap, 0, wxALL, 2 );


	bSizer227->Add( bSizer221, 1, wxEXPAND, 5 );

	m_charelan = new wxCheckBox( m_panelchar, wxID_ANY, _("Keep Elan principle"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charelan->SetValue(true);
	m_charelan->SetToolTip( _("When activated, Elan spells are multi-target versions of Flair spells\nOtherwise they are shuffled with the others") );

	bSizer227->Add( m_charelan, 0, wxALL, 5 );

	m_charspellsafe = new wxCheckBox( m_panelchar, wxID_ANY, _("Exclude Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charspellsafe->SetValue(true);
	bSizer227->Add( m_charspellsafe, 0, wxALL, 5 );


	bSizer225->Add( bSizer227, 1, wxEXPAND, 5 );

	m_staticline51 = new wxStaticLine( m_panelchar, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	bSizer225->Add( m_staticline51, 0, wxEXPAND | wxALL, 5 );

	wxBoxSizer* bSizer228;
	bSizer228 = new wxBoxSizer( wxVERTICAL );

	m_charsupport = new wxCheckBox( m_panelchar, wxID_CHARSUPP, _("Randomize Supporting Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charsupport->SetValue(true);
	bSizer228->Add( m_charsupport, 0, wxALL, 5 );

	m_charsupportsafe = new wxCheckBox( m_panelchar, wxID_ANY, _("Exclude Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_charsupportsafe->SetValue(true);
	bSizer228->Add( m_charsupportsafe, 0, wxALL, 5 );


	bSizer225->Add( bSizer228, 1, wxEXPAND, 5 );


	fgSizer112->Add( bSizer225, 1, wxEXPAND, 5 );


	m_panelchar->SetSizer( fgSizer112 );
	m_panelchar->Layout();
	fgSizer112->Fit( m_panelchar );
	m_auinotebook5->AddPage( m_panelchar, _("Characters"), true, wxNullBitmap );
	m_panelweap = new wxScrolledWindow( m_auinotebook5, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	m_panelweap->SetScrollRate( 5, 5 );
	...
	wxGridBagSizer* gbSizer52;
	gbSizer52 = new wxGridBagSizer( 0, 0 );
	gbSizer52->SetFlexibleDirection( wxBOTH );
	gbSizer52->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxString m_weapabilChoices[] = { _("Do not modify"), _("Shuffle Abilities"), _("Randomize Abilities") };
	int m_weapabilNChoices = sizeof( m_weapabilChoices ) / sizeof( wxString );
	m_weapabil = new wxChoice( m_panelweap, wxID_WEAPABIL, wxDefaultPosition, wxDefaultSize, m_weapabilNChoices, m_weapabilChoices, 0 );
	m_weapabil->SetSelection( 2 );
	gbSizer52->Add( m_weapabil, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL, 5 );

	m_weapall = new wxCheckBox( m_panelweap, wxID_ANY, _("Make sure all Spells can be learned"), wxDefaultPosition, wxDefaultSize, 0 );
	m_weapall->SetValue(true);
	gbSizer52->Add( m_weapall, wxGBPosition( 1, 0 ), wxGBSpan( 1, 2 ), wxALL, 5 );

	m_weapsafe = new wxCheckBox( m_panelweap, wxID_ANY, _("Exclude Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_weapsafe->SetValue(true);
	gbSizer52->Add( m_weapsafe, wxGBPosition( 0, 1 ), wxGBSpan( 1, 1 ), wxALL, 8 );

	wxBoxSizer* bSizer217;
	bSizer217 = new wxBoxSizer( wxHORIZONTAL );

	m_weapslotlabel = new wxStaticText( m_panelweap, wxID_ANY, _("Proportion of slots used"), wxDefaultPosition, wxDefaultSize, 0 );
	m_weapslotlabel->Wrap( -1 );
	bSizer217->Add( m_weapslotlabel, 0, wxALL, 5 );

	m_weapslot = new wxSpinCtrl( m_panelweap, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 61 );
	m_weapslot->SetToolTip( _("Default proportion in normal games: 61%") );

	bSizer217->Add( m_weapslot, 0, wxALL, 2 );


	gbSizer52->Add( bSizer217, wxGBPosition( 2, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );

	wxBoxSizer* bSizer218;
	bSizer218 = new wxBoxSizer( wxHORIZONTAL );

	m_weapsupportlabel = new wxStaticText( m_panelweap, wxID_ANY, _("Proportion of Supporting Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_weapsupportlabel->Wrap( -1 );
	bSizer218->Add( m_weapsupportlabel, 0, wxALL, 5 );

	m_weapsupport = new wxSpinCtrl( m_panelweap, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 19 );
	m_weapsupport->SetToolTip( _("Default proportion in normal games: 19%") );

	bSizer218->Add( m_weapsupport, 0, wxALL, 2 );


	gbSizer52->Add( bSizer218, wxGBPosition( 3, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );


	fgSizer113->Add( gbSizer52, 1, wxEXPAND, 5 );


	m_panelweap->SetSizer( fgSizer113 );
	m_panelweap->Layout();
	fgSizer113->Fit( m_panelweap );
	m_auinotebook5->AddPage( m_panelweap, _("Weapons"), false, wxNullBitmap );
	m_panelarmor = new wxScrolledWindow( m_auinotebook5, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	m_panelarmor->SetScrollRate( 5, 5 );
	...
	wxGridBagSizer* gbSizer521;
	gbSizer521 = new wxGridBagSizer( 0, 0 );
	gbSizer521->SetFlexibleDirection( wxBOTH );
	gbSizer521->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	wxString m_armorabilChoices[] = { _("Do not modify"), _("Shuffle Abilities"), _("Randomize Abilities") };
	int m_armorabilNChoices = sizeof( m_armorabilChoices ) / sizeof( wxString );
	m_armorabil = new wxChoice( m_panelarmor, wxID_ARMORABIL, wxDefaultPosition, wxDefaultSize, m_armorabilNChoices, m_armorabilChoices, 0 );
	m_armorabil->SetSelection( 2 );
	gbSizer521->Add( m_armorabil, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL, 5 );

	m_armorall = new wxCheckBox( m_panelarmor, wxID_ANY, _("Make sure all Supporting Abilities can be learned"), wxDefaultPosition, wxDefaultSize, 0 );
	m_armorall->SetValue(true);
	gbSizer521->Add( m_armorall, wxGBPosition( 1, 0 ), wxGBSpan( 1, 2 ), wxALL, 5 );

	m_armorsafe = new wxCheckBox( m_panelarmor, wxID_ANY, _("Exclude Safe Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_armorsafe->SetValue(true);
	gbSizer521->Add( m_armorsafe, wxGBPosition( 0, 1 ), wxGBSpan( 1, 1 ), wxALL, 8 );

	wxBoxSizer* bSizer2171;
	bSizer2171 = new wxBoxSizer( wxHORIZONTAL );

	m_armorslotlabel = new wxStaticText( m_panelarmor, wxID_ANY, _("Proportion of slots used"), wxDefaultPosition, wxDefaultSize, 0 );
	m_armorslotlabel->Wrap( -1 );
	bSizer2171->Add( m_armorslotlabel, 0, wxALL, 5 );

	m_armorslot = new wxSpinCtrl( m_panelarmor, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 65 );
	m_armorslot->SetToolTip( _("Default proportion in normal games: 65%") );

	bSizer2171->Add( m_armorslot, 0, wxALL, 2 );


	gbSizer521->Add( bSizer2171, wxGBPosition( 2, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );

	wxBoxSizer* bSizer2181;
	bSizer2181 = new wxBoxSizer( wxHORIZONTAL );

	m_armorsupportlabel = new wxStaticText( m_panelarmor, wxID_ANY, _("Proportion of Supporting Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	m_armorsupportlabel->Wrap( -1 );
	bSizer2181->Add( m_armorsupportlabel, 0, wxALL, 5 );

	m_armorsupport = new wxSpinCtrl( m_panelarmor, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 78 );
	m_armorsupport->SetToolTip( _("Default proportion in normal games: 78%") );

	bSizer2181->Add( m_armorsupport, 0, wxALL, 2 );


	gbSizer521->Add( bSizer2181, wxGBPosition( 3, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );


	fgSizer1131->Add( gbSizer521, 1, wxEXPAND, 5 );


	m_panelarmor->SetSizer( fgSizer1131 );
	m_panelarmor->Layout();
	fgSizer1131->Fit( m_panelarmor );
	m_auinotebook5->AddPage( m_panelarmor, _("Armors"), false, wxNullBitmap );
	m_panelbattle = new wxScrolledWindow( m_auinotebook5, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	m_panelbattle->SetScrollRate( 5, 5 );
	...
	wxGridBagSizer* gbSizer57;
	gbSizer57 = new wxGridBagSizer( 0, 0 );
	gbSizer57->SetFlexibleDirection( wxBOTH );
	gbSizer57->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_battlespell = new wxCheckBox( m_panelbattle, wxID_BATTLESPELL, _("Shuffle Spells"), wxDefaultPosition, wxDefaultSize, 0 );
	m_battlespell->SetValue(true);
	m_battlespell->SetToolTip( _("Shuffle all the spells used by the enemies") );

	gbSizer57->Add( m_battlespell, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL, 5 );

	m_battleprop = new wxCheckBox( m_panelbattle, wxID_ANY, _("Keep proportions"), wxDefaultPosition, wxDefaultSize, 0 );
	m_battleprop->SetValue(true);
	m_battleprop->SetToolTip( _("When on, the most common spells used by the enemies are still more common after randomizing\nWhen off, the frequencies are uniform and the spell powers of similar spells are evened") );

	gbSizer57->Add( m_battleprop, wxGBPosition( 1, 0 ), wxGBSpan( 1, 1 ), wxALL, 5 );

	wxBoxSizer* bSizer222;
	bSizer222 = new wxBoxSizer( wxVERTICAL );

	m_battlemp = new wxCheckBox( m_panelbattle, wxID_MP, _("Downscale Max MP"), wxDefaultPosition, wxDefaultSize, 0 );
	m_battlemp->SetValue(true);
	bSizer222->Add( m_battlemp, 0, wxALL, 1 );

	m_battlempfactor = new wxSpinCtrl( m_panelbattle, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 500, 5 );
	m_battlempfactor->SetToolTip( _("Max MP = Lvl * this\nUsing a value of 5, a goblin has enough MP to cast Bio once or Thundara twice but not Meteor\nKeep in mind that not all big attacks require MP and downscaling the Max MP is not the guarantee of any kind of balance") );

	bSizer222->Add( m_battlempfactor, 0, wxALL, 5 );


	gbSizer57->Add( bSizer222, wxGBPosition( 0, 1 ), wxGBSpan( 2, 1 ), wxEXPAND, 5 );


	fgSizer119->Add( gbSizer57, 1, wxEXPAND, 5 );


	m_panelbattle->SetSizer( fgSizer119 );
	m_panelbattle->Layout();
	fgSizer119->Fit( m_panelbattle );
	m_auinotebook5->AddPage( m_panelbattle, _("Enemies"), false, wxNullBitmap );
	m_panelcard = new wxScrolledWindow( m_auinotebook5, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	m_panelcard->SetScrollRate( 5, 5 );
	wxFlexGridSizer* fgSizer118;
	fgSizer118 = new wxFlexGridSizer( 0, 2, 0, 0 );
	...
	m_carddrop = new wxCheckBox( m_panelcard, wxID_ANY, _("Randomize Card drop"), wxDefaultPosition, wxDefaultSize, 0 );
	m_carddrop->SetValue(true);
	bSizer231->Add( m_carddrop, 0, wxALL, 8 );


	bSizer230->Add( bSizer231, 1, wxEXPAND, 5 );

	m_staticline9 = new wxStaticLine( m_panelcard, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
	bSizer230->Add( m_staticline9, 0, wxEXPAND | wxALL, 5 );

	wxBoxSizer* bSizer232;
	bSizer232 = new wxBoxSizer( wxVERTICAL );

	wxString m_carddeckChoices[] = { _("Keep opponent Decks"), _("Shuffle opponent Decks"), _("Randomize opponent Decks") };
	int m_carddeckNChoices = sizeof( m_carddeckChoices ) / sizeof( wxString );
	m_carddeck = new wxChoice( m_panelcard, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_carddeckNChoices, m_carddeckChoices, 0 );
	m_carddeck->SetSelection( 0 );
	m_carddeck->SetToolTip( _("When you feel that Tetra Master lacks of randomness") );

	bSizer232->Add( m_carddeck, 0, wxALL, 5 );


	bSizer230->Add( bSizer232, 1, wxEXPAND, 5 );


	fgSizer118->Add( bSizer230, 1, wxEXPAND, 5 );


	m_panelcard->SetSizer( fgSizer118 );
	m_panelcard->Layout();
	fgSizer118->Fit( m_panelcard );
	m_auinotebook5->AddPage( m_panelcard, _("Cards"), false, wxNullBitmap );

	fgSizer85->Add( m_auinotebook5, 1, wxEXPAND | wxALL, 5 );
	...
	m_buttonok = new wxButton( this, wxID_OK, _("Randomize!"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer124->Add( m_buttonok, 0, wxALL, 5 );


	fgSizer85->Add( bSizer124, 1, wxALIGN_RIGHT, 5 );
	...
	// Connect Events
	m_enableseed->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_safeabilbtn->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_loadallbtn->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_enablechar->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enableweap->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablearmor->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablebattle->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablecard->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_charspellpower->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_charspellstatus->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_charspell->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_charsupport->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_weapabil->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_armorabil->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_battlespell->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_battlemp->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_buttonapply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_buttoncancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_buttonok->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
}

RandomizerWindow::~RandomizerWindow()
{
	// Disconnect Events
	m_enableseed->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_safeabilbtn->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_loadallbtn->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_enablechar->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enableweap->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablearmor->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablebattle->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_enablecard->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_charspellpower->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_charspellstatus->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_charspell->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_charsupport->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_weapabil->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_armorabil->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( RandomizerWindow::OnChoice ), NULL, this );
	m_battlespell->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_battlemp->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerWindow::OnCheckBox ), NULL, this );
	m_buttonapply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_buttoncancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );
	m_buttonok->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerWindow::OnButtonClick ), NULL, this );

}

RandomizerListWindow::RandomizerListWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_buttonremove = new wxButton( this, wxID_REMOVE, _("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer126->Add( m_buttonremove, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );

	m_safelist = new wxListBox( this, wxID_USERLIST, wxDefaultPosition, wxSize( 135,200 ), 0, NULL, wxLB_HSCROLL );
	bSizer126->Add( m_safelist, 0, wxALL, 5 );
	...
	m_staticText408 = new wxStaticText( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText408->Wrap( -1 );
	bSizer223->Add( m_staticText408, 0, wxALL, 12 );

	m_scramble = new wxCheckBox( this, wxID_SPELLSTAT, _("Spell Stats"), wxPoint( -1,-1 ), wxDefaultSize, 0 );
	bSizer223->Add( m_scramble, 0, wxALL, 5 );

	m_spell = new wxCheckBox( this, wxID_SPELL, _("Character Spells"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer223->Add( m_spell, 0, wxALL, 5 );

	m_support = new wxCheckBox( this, wxID_SUPPORT, _("Supporting Abilities"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer223->Add( m_support, 0, wxBOTTOM|wxLEFT|wxTOP, 5 );

	m_weap = new wxCheckBox( this, wxID_WEAPON, _("Weapons"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer223->Add( m_weap, 0, wxALL, 5 );

	m_armor = new wxCheckBox( this, wxID_ARMOR, _("Armors"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer223->Add( m_armor, 0, wxALL, 5 );


	fgSizer46->Add( bSizer223, 1, wxEXPAND, 5 );
	...
	// Connect Events
	m_buttonadd->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_fulllist->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( RandomizerListWindow::OnList ), NULL, this );
	m_fulllist->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( RandomizerListWindow::OnListDClick ), NULL, this );
	m_buttonremove->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_safelist->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( RandomizerListWindow::OnList ), NULL, this );
	m_safelist->Connect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( RandomizerListWindow::OnListDClick ), NULL, this );
	m_scramble->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_spell->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_support->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_weap->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_armor->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_buttoncancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_buttonok->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
}

RandomizerListWindow::~RandomizerListWindow()
{
	// Disconnect Events
	m_buttonadd->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_fulllist->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( RandomizerListWindow::OnList ), NULL, this );
	m_fulllist->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( RandomizerListWindow::OnListDClick ), NULL, this );
	m_buttonremove->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_safelist->Disconnect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( RandomizerListWindow::OnList ), NULL, this );
	m_safelist->Disconnect( wxEVT_COMMAND_LISTBOX_DOUBLECLICKED, wxCommandEventHandler( RandomizerListWindow::OnListDClick ), NULL, this );
	m_scramble->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_spell->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_support->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_weap->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_armor->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnCheckBox ), NULL, this );
	m_buttoncancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
	m_buttonok->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( RandomizerListWindow::OnButtonClick ), NULL, this );
...
BackgroundEditorWindow::BackgroundEditorWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_imagepicker = new wxFilePickerCtrl( m_panelconverter, wxID_ANY, wxEmptyString, _("Select a file"), _("Supported Image|*.tiff;*.tif;*.bmp;*.tga|All files|*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE );
	...
	m_importlauncher = new wxFilePickerCtrl( m_panelimporter, wxID_ANY, wxEmptyString, _("Select a file"), _("Steam game|FF9_Launcher.exe"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE );
...
UnityViewerWindow::UnityViewerWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_assetlist = new wxListCtrl( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_HRULES|wxLC_REPORT|wxBORDER_NONE );
	...
	// Connect Events
	m_menufile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menuopen->GetId());
	m_menufile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menureopen->GetId());
	m_menufile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menuclose->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata11->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata12->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata13->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata14->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata15->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata16->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata17->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata18->GetId());
	m_submenufield->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata19->GetId());
	m_submenudata->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata2->GetId());
	m_submenudata->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata3->GetId());
	m_submenudata->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata4->GetId());
	m_submenudata->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata5->GetId());
	m_submenuaudio->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata61->GetId());
	m_submenuaudio->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata62->GetId());
	m_submenuaudio->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata63->GetId());
	m_submenudata->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menupdata7->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel0->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel1->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel2->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel3->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel4->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel5->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel6->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel7->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel8->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel9->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel10->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel11->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel12->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel13->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel14->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel15->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel16->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel17->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel18->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel19->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel20->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel21->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel22->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel23->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel24->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel25->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel26->GetId());
	m_submenulevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menulevel27->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menuresources->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menumaindata->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared0->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared1->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared2->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared3->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared4->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared5->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared6->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared7->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared8->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared9->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared10->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared11->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared12->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared13->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared14->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared15->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared16->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared17->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared18->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared19->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared20->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared21->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared22->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared23->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared24->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared25->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared26->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared27->GetId());
	m_submenushared->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menushared28->GetId());
	m_menuoptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menufolderx64->GetId());
	m_menuoptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( UnityViewerWindow::OnMenuSelection ), this, m_menufolderx86->GetId());
...
UnityLinkFileWindow::UnityLinkFileWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_message = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 525,80 ), wxTE_MULTILINE|wxTE_READONLY|wxTE_WORDWRAP|wxBORDER_SIMPLE );
...
UnityAddFilePanel::UnityAddFilePanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	wxGridBagSizer* gbSizer46;
	gbSizer46 = new wxGridBagSizer( 0, 0 );
	gbSizer46->SetFlexibleDirection( wxBOTH );
	...
	m_filepicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE );
	...
	m_panel90 = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL|wxBORDER_SUNKEN );
...
MenuDEBUG::MenuDEBUG( long style ) : wxMenuBar( style )
{
	...
	// Connect Events
	m_menu6->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuDEBUG::OnDebugClick ), this, debug->GetId());
}
