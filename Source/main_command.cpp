...
void InitConstEditableField() {
	...
	const_editable_field = new editable_field*[EDITABLE_FIELD_COUNT] {
		...
		new editable_field_numerical(L"status_set.status", [](SaveSet& sv, FieldSelector& sel) { return sel.status_set_index < STATUS_SET_AMOUNT; }, [](SaveSet& sv, FieldSelector& sel, long long val) { sv.spellset->status_set[sel.status_set_index] = val; sv.sectionmodified[DATA_SECTION_SPELL] = true; }, [](SaveSet& sv, FieldSelector& sel) { return sv.spellset->status_set[sel.status_set_index]; }),
		...
		new editable_field_numerical(L"ability_list.slot.ability", [](SaveSet& sv, FieldSelector& sel) { return sel.ability_list_index < ABILITY_SET_AMOUNT && sel.ability_list__slot_index < ABILITY_SET_CAPACITY; }, [](SaveSet& sv, FieldSelector& sel, long long val) { sv.statset->ability_list[sel.ability_list_index].ability[sel.ability_list__slot_index] = val; sv.sectionmodified[DATA_SECTION_STAT] = true; }, [](SaveSet& sv, FieldSelector& sel) { return sv.statset->ability_list[sel.ability_list_index].ability[sel.ability_list__slot_index]; }),
		...
		new editable_field_numerical(L"item.skillslot.skill", [](SaveSet& sv, FieldSelector& sel) { return sel.item_index < ITEM_AMOUNT && sel.item__skillslot_index < 3; }, [](SaveSet& sv, FieldSelector& sel, long long val) { sv.itemset->item[sel.item_index].skill[sel.item__skillslot_index] = val; sv.sectionmodified[DATA_SECTION_ITEM] = true; }, [](SaveSet& sv, FieldSelector& sel) { return sv.itemset->item[sel.item_index].skill[sel.item__skillslot_index]; }),
		...
		new editable_field_numerical(L"synthesis.recipe1", [](SaveSet& sv, FieldSelector& sel) { return sel.synthesis_index < SYNTHESIS_AMOUNT; }, [](SaveSet& sv, FieldSelector& sel, long long val) { sv.shopset->synthesis[sel.synthesis_index].recipe1 = val; sv.sectionmodified[DATA_SECTION_SHOP] = true; }, [](SaveSet& sv, FieldSelector& sel) { return sv.shopset->synthesis[sel.synthesis_index].recipe1; }),
		new editable_field_numerical(L"synthesis.recipe2", [](SaveSet& sv, FieldSelector& sel) { return sel.synthesis_index < SYNTHESIS_AMOUNT; }, [](SaveSet& sv, FieldSelector& sel, long long val) { sv.shopset->synthesis[sel.synthesis_index].recipe2 = val; sv.sectionmodified[DATA_SECTION_SHOP] = true; }, [](SaveSet& sv, FieldSelector& sel) { return sv.shopset->synthesis[sel.synthesis_index].recipe2; }),
